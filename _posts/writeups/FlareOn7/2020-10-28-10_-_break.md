...
![Child SIG Handling](img/10_dochild_syscalls.png)
...
![Write Syscall handler](img/10_write.png)
...
![Read Syscall handler](img/10_read.png)
...
![SIGILL Handler](img/10_0f0b_handler.png)
...
![Real Check Flag](img/10_real_check_flag.png)
...
![Check Second Part](img/10_checkSecondPart.png)
...
![Decryption Function](img/10_fun369.png)

![Initialize Buffer](img/10_fun217.png)
...
![SIGSEGV](img/10_sigsegv_handler.png)
...
![Truncate Handler](img/10_truncate.png)
...
![Overwritten Address](img/10_overwritten_addr.png)
...
![BigIntegers Equation](img/10_last_equation.png)
